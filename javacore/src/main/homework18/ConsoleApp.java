...
import main.homework18.exception.CheckingMethods;
import main.homework18.famelyDao.CollectionFamilyDao;
import main.homework18.famelyDao.FamilyController;
import main.homework18.famelyDao.FamilyDao;
import main.homework18.famelyDao.FamilyService;
import main.homework18.family.Human;
import main.homework18.family.Man;
import main.homework18.family.Woman;
...
public class ConsoleApp {
    ...
    private String[] choices1 = {"Заполнить тестовыми данными.", "Отобразить весь список семей",
            ...
            "Удалить всех детей старше возраста...","Запись семей в файл", "Exit"};
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "9":
                    ...
                    continue outerLoop;
                case "10":
                    fw.write(familyController.getAllFamilies());
                    continue outerLoop;
                case "11":
                    break outerLoop;
                default:
